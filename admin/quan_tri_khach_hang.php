...
<head>
  ...
  <div id="pcoded" class="pcoded">
      ...
      <div class="pcoded-container navbar-wrapper">
          ...
          <div class="pcoded-main-container">
              <div class="pcoded-wrapper">
                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          </li><li class="breadcrumb-item"><a href="#!">Quản trị khách hàng</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                  ...
                  <h1 style="text-align:center;">QUẢN TRỊ KHÁCH HÀNG</h1>
                  <br>
                  <div>
    ...
    <tr>
      ...
      <td style="width: 600px; text-align: center; font-weight: bold;">Tên người dùng</td>
      <td style="width: 90px; text-align: center; font-weight: bold;">Địa chỉ</td>
      <td style="width: 90px; text-align: center; font-weight: bold;">SĐT</td>
      <td style="width: 50px; text-align: center; font-weight: bold;">Gmail</td>
      <td style="width: 50px; text-align: center; font-weight: bold;">CCCD</td>
      <td style="width: 50px; text-align: center; font-weight: bold;">Ghi chú</td>
      <td style="width: 40px; text-align: center; font-weight: bold;">Sửa</td>
      <td style="width: 50px; text-align: center; font-weight: bold;">Xóa</td>
    </tr>
    <?php 
    ...
    <tr>
      ...
      <td style="text-align: center;"><?php echo $row["kh_dia_chi"];?></td>
      <td style="text-align: center;"><?php echo $row["kh_dien_thoai"];?></td>
      <td style="text-align: center;"><?php echo $row["kh_email"];?></td>
      <td style="text-align: center;"><?php echo $row["kh_cccd"];?></td>
      <td style="text-align: center;"><?php echo $row["kh_ghi_chu"];?></td>
      <td style="text-align: center;"><a href="khach_hang_sua.php?kh_id=<?php echo $row['kh_id'];?>"><img style="width: 15px; height: auto;" src="./img/pencil.png"></a></td>
      <td style="text-align: center;"><a href="khach_hang_xoa.php?kh_id=<?php echo $row['kh_id'];?>"><img style="width: 15px; height: auto;" src="./img/delete.png"></a></td>
