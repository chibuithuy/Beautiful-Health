                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Sửa loại sản phẩm</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                          ...
                                          include("../config/dbconfig.php"); 
                                                  ...
                                                  $id = $_GET["lsp_id"];
                                                  $sql="SELECT * FROM `tbl_loai_sp` WHERE lsp_id=" .$id;
                                                  $loaisp=mysqli_query($ketnoi,$sql);
                                                  $row=mysqli_fetch_array($loaisp);
                                            ...
                                            <div class="col-xl-8 col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                      <h2 style="text-align:center;">TRANG SỬA LOẠI SẢN PHẨM</h2>
                                                        <!--     enctype="multipart/form-data" dùng để gửi file từ form này sang form khác     -->
                                                        <form action="loai_san_pham_sua_thuc_hien.php" method="POST" enctype="multipart/form-data"> 
                                                            <p style="text-align:center;font-weight: bold;" >Tên loại sản phẩm</p>
                                                            <p style="text-align:center;"><input type="text" name="txtTenLoaiSanPham" value="<?php echo $row['lsp_ten'];?>" placeholder="Nhập tên loại sản phẩm" style=" width: 80%;" ></p>  
                                                            <p style="text-align:center;font-weight: bold;" >Số lượng</p>
                                                            <p style="text-align:center"><input type="text" value="<?php echo $row['lsp_so_luong'];?>" name="txtSoLuong" style=" width: 80%;"></p>                                                              
                                                            <p style="text-align: center;"><input type="hidden" name="txtID" value="<?php echo $row['lsp_id'];?>"><button type="submit">Cập Nhật</button></p>
                                                        </form>
                                                </div>
                                                </div>
                                            </div>
