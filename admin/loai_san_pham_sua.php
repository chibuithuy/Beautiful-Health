                                                    ...
                                                    <div class="card-header">
                                                      <h2 style="text-align:center;">TRANG SỬA LOẠI SẢN PHẨM</h2>
                                                        ...
                                                        <form action="loai_san_pham_sua_thuc_hien.php" method="POST" enctype="multipart/form-data"> 
                                                            ...
                                                            <p style="text-align:center"><input type="text" value="<?php echo $row['lsp_so_luong'];?>" name="txtSoLuong" style=" width: 80%;"></p>                                                              <p style="text-align: center;"><input type="hidden" name="txtID" value="<?php echo $row['lsp_id'];?>"><button type="submit">Cập Nhật</button></p>
                                                        </form>
                                                </div>
                                                </div>
                                            </div>
