            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" method="POST"  action="kiem_tra_dang_nhap.php">
                            <div class="text-center">
                                <img src="img/star.png" alt="logo.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h3 class="text-center">Đăng nhập trang quản trị</h3>
                                        </div>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="text" name="txtUserName" class="form-control" required="">
                                        <span class="form-bar"></span>
                                        <label class="float-label">Tên tài khoản</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="password" name="txtPassword" class="form-control" required="">
                                        <span class="form-bar"></span>
                                        <label class="float-label">Mật khẩu</label>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="checkbox-fade fade-in-primary d-">
                                                <label>
                                                    ...
                                                    <span class="text-inverse">Lưu mật khẩu</span>
                                                </label>
                                            </div>
                                            <div class="forgot-phone text-right f-right">
                                                <a href="#" class="text-right f-w-600"> Quên mật khẩu?</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Đăng nhập</button>
                                        </div>
                                    </div>
                                    <hr/>
                                </div>
