...
<head>
  ...
  <div id="pcoded" class="pcoded">
      ...
      <div class="pcoded-container navbar-wrapper">
          ...
          <div class="pcoded-main-container">
              <div class="pcoded-wrapper">
                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Quản trị loại sản phẩm</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                  ...
                  <h1 style="text-align:center;">QUẢN TRỊ LOẠI SẢN PHẨM</h1>
                  <br>
                  <div>
                    <p style="text-align: right;">
                      <a href="loai_san_pham_them_moi.php">
    ...
    <tr>
      ...
      <td style="width: 250pxpx; text-align: center; font-weight: bold;">Tên loại sản phẩm</td>
    ...
    // In kết quả truy vấn ra màn hình
                      ...
                      $sql = "
                        SELECT * 
                        FROM tbl_loai_sp
                        ORDER BY lsp_id DESC";
                      $loai_sp = mysqli_query($ketnoi, $sql);
    $i=0;
    ...
    <tr>
      ...
      <td style="text-align: center;"><?php echo $row["lsp_so_luong"];?></td>
      <td style="text-align: center;"><a href="loai_san_pham_sua.php?lsp_id=<?php echo $row['lsp_id'];?>"><img style="width: 15px; height: auto;" src="./img/pencil.png"></a></td>
      <td style="text-align: center;"><a href="loai_san_pham_xoa.php?lsp_id=<?php echo $row['lsp_id'];?>"><img style="width: 15px; height: auto;" src="./img/delete.png"></a></td>
