...
<head>
  ...
  <body>
      <?php
                ...
                $noidungtruyvan = mysqli_query($ketnoi, $sql1);
                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Sửa sản phẩm</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                          ...
                                          include("../config/dbconfig.php"); 
                                                  ...
                                                  $id = $_GET["id"];
                                                  $sql="select tbl_san_pham.* from tbl_san_pham where tbl_san_pham.sp_id=" .$id;
                                                  $sanpham=mysqli_query($ketnoi,$sql);
