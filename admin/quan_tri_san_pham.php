              ...
              <div class="pcoded-wrapper">
                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Quản trị sản phẩm</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                  ...
                  <div>
                    <p style="text-align: right;">
                      <a href="san_pham_them_moi.php">
                      <img src="./img/plus.png"style="width: 20px; height: auto;">
                    </a>
                  </p>
                      <table border="1" cellspacing="0" cellpadding="10" style="width: 1200px;">
                        <tr>
                          <td style="width: 50px; text-align: center; font-weight: bold;">STT</td>
                          <td style="width: 100px; text-align: center; font-weight: bold;">Tên sản phẩm</td>
