                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="quan_tri_tin_tuc.php">Quản trị tin tức</a>
                                          </li>
                                          <li class="breadcrumb-item"><a href="#!">Sửa tin tức</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                        ...
                                        <div class="row">
                                          ...
                                          include("../config/dbconfig.php"); 
                                                  ...
                                                  $sql = "
                                                    ...
                                                    FROM tbl_tin_tuc
                                                    WHERE tt_id = ".$id;
                                                  $tintuc=mysqli_query($ketnoi,$sql);
                                            ...
                                            <div class="col-xl-8 col-md-12">
                                                <div class="card">
													...
													<form action="tin_tuc_sua_thuc_hien.php" method="POST" enctype="multipart/form-data"> 
														<p style="text-align:center;font-weight: bold;" >Tiêu đề vài viết</p>
														<p style="text-align:center;"><input type="text" name="txtTieuDe" value="<?php echo $row['tt_tieu_de'];?>" placeholder="Nhập tiêu đề bài viết" style=" width: 80%;" ></p>  
														<p style="text-align:center;font-weight: bold;" >Mô tả bài viết</p>
														<p style="text-align:center"><textarea name="txtMota" style=" width: 80%; height: 200px;"> </textarea></p>  
														<p style="text-align:center;"><input type="file" name="txtAnhMinhHoa" value="" style=" width: 80%;" ></p>  
