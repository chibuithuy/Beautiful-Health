                      ...
                      <ul class="nav-right">
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  <img src="img/star.png" class="img-radius" alt="User-Profile-Image">
                  ...
                  <nav class="pcoded-navbar">
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              ...
                              <img src="img/star.png" class="img-radius" alt="User-Profile-Image">                                  <div class="user-details">
                                    ...
                                    <ul class="pcoded-item pcoded-left-item">
                                        ...
                                        <li>
                                            <a href="quan_tri_loai_san_pham.php" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                                <span class="pcoded-mtext" data-i18n="nav.form-components.main">Quản trị Loại Sản Phẩm</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Trang quản trị</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-purple">Quản trị sản phẩm</h4>
                                                                <h6 class="text-muted m-b-0"><?php echo $soluong2;?> sản phẩm</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                                <i class="fa fa-bed f-28"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer bg-c-purple">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <a style="font-weight: bold;" href="quan_tri_san_pham.php" class="text-white m-b-0">Chi tiết</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h5 class="text-c-green">Quản trị tin tức</h4>
                                                                <h6 class="text-muted m-b-0"><?php echo $soluong4;?> tin tức</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                                <i class="fa fa-newspaper-o f-28"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer bg-c-green">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <a style="font-weight: bold;" href="quan_tri_tin_tuc.php" class="text-white m-b-0">Chi tiết</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-red">Quản trị đơn đặt hàng</h4>
                                                                <h6 class="text-muted m-b-0"><?php echo $soluong5;?> đơn đặt hàng</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                                <i class="fa fa-check f-28"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer bg-c-red">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <a style="font-weight: bold;" href="quan_tri_don_dat_hang.php" class="text-white m-b-0">Chi tiết</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-purple">Quản trị loại sản phẩm</h4>
                                                                <h6 class="text-muted m-b-0"><?php echo $soluong5;?> loại sản phẩm</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                    ...
                                                    <div class="card-footer bg-c-purple">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <a style="font-weight: bold;" href="quan_tri_loai_san_pham.php" class="text-white m-b-0">Chi tiết</a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-blue">Quản trị Admin</h4>
                                                                <h6 class="text-muted m-b-0"><?php echo $soluong;?> người quản trị</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                                <i class="fa fa-shield f-28"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer bg-c-blue">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <a style="font-weight: bold;"  href="quan_tri_admin.php" class="text-white m-b-0">Chi tiết</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h5 class="text-c-green">Quản trị Khách hàng</h4>
                                                                <h6 class="text-muted m-b-0"><?php echo $soluong1;?> người dùng</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                    ...
                                                    <div class="card-footer bg-c-green">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <a style="font-weight: bold;" href="quan_tri_khach_hang.php" class="text-white m-b-0">Chi tiết</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
