                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                          <li class="user-profile header-notification">
                              ...
                              <img class="img-fluid" src="img/star.png" alt="Theme-Logo" />                                  <span><?php echo "Xin chào ";Echo $row['admin_ten_dang_nhap'];?> </span>
                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="quan_tri_admin.php">Quản trị Admin</a>
                                          </li>
                                          <li class="breadcrumb-item"><a href="#!">Thêm mới quản trị viên</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                          ...
                                          include("../config/dbconfig.php"); ?>
                                            <div class="col-xl-8 col-md-12">
                                                <div class="card">
                                                    ...
                                                    <br><br><br>
                                                    <form method="post" action="admin_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Tên đăng nhập<span class="required">*</span></label>
                                                      <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input name="txtTen" required type="text" class="form-control">
                                                      </div>
                                                    </div>
                                                    <br><br><br>
                                                  <div class="form-group">
                                                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Mật khẩu<span class="required">*</span></label>
                                                      <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input name="txtPassword" required type="text" class="form-control">
                                                      </div>
                                                    </div>
                                                    <br><br><br>
                                                    <div class="form-group">
                                                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Họ tên<span class="required">*</span></label>
                                                      <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input name="txtHoTen" required type="text" class="form-control">
                                                      </div>
                                                    </div>
                                                    <br><br><br>
                                                    <div class="form-group">
                                                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Điện thoại<span class="required">*</span></label>
                                                      <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input name="txtDienThoai" required type="text" class="form-control">
                                                      </div>
                                                    </div>
                                                    <br><br><br>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group" style="margin-left: 300px ;">
                                                      <button type="submit">Thêm mới người dùng</button>
                                                    </div>
                                                    <br>
