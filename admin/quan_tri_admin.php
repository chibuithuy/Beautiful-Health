...
<head>
  ...
  <div id="pcoded" class="pcoded">
      ...
      <div class="pcoded-container navbar-wrapper">
          ...
          <div class="pcoded-main-container">
              <div class="pcoded-wrapper">
                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Quản trị admin</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                  ...
                  <h1 style="text-align:center;">QUẢN TRỊ ADMIN</h1>
                  <br>
                  <div>
                    <p style="text-align: right;">
                      <a href="admin_them_moi.php">
    ...
    <tr>
      ...
      <td style="width: 90px; text-align: center; font-weight: bold;">Mật khẩu</td>
      <td style="width: 90px; text-align: center; font-weight: bold;">Họ tên</td>
    ...
    <tr>
      ...
      <td style="text-align: center;"><?php echo $row["admin_ten_dang_nhap"];?></td>
      <td style="text-align: center;"><?php echo $row["admin_mat_khau"];?></td>
      <td style="text-align: center;"><?php echo $row["admin_ho_ten"];?></td>
      <td style="text-align: center;"><a href="admin_sua.php?admin_id=<?php echo $row['admin_id'];?>"><img style="width: 15px; height: auto;" src="img/pencil.png"></a></td>
      <td style="text-align: center;"><a href="admin_xoa.php?admin_id=<?php echo $row['admin_id'];?>"><img style="width: 15px; height: auto;" src="img/delete.png"></a></td>
    </tr>
    <?php 
    }
    ;?>
