                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Sửa quản trị viên</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                            ...
                                            <div class="col-xl-8 col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h2 style="text-align:center;">Trang sửa quản trị viên</h2>
                                                    </div>
                                                    <form method="post" action="admin_sua_thuc_hien.php" enctype="multipart/form-data">
                                                      <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Tên người dùng<span class="required">*</span></label>
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                          <input name="txtTen" type="text" class="form-control" value="<?php echo $row["admin_ten_dang_nhap"];?>">
                                                        </div>
                                                      </div>
                                                      ...
                                                      <div style="" class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                          <input name="txtPassword" type="text" class="form-control" value="<?php echo $row["admin_mat_khau"];?>">
                                                        </div>
                                                      </div>
                                                       <br><br><br>
                                                      <div class="form-group" style="margin-left: 375px;">
                                                       <input type="hidden" name="txtID" value='<?php echo $row["admin_id"];?>'>
