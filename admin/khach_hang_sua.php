                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Sửa khách hàng</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                          ...
                                          include("../config/dbconfig.php"); 
                                                  ...
                                                  $id = $_GET["kh_id"];
                                                  $sql="SELECT * FROM tbl_khach_hang WHERE kh_id=" .$id;
                                            ...
                                            <div class="col-xl-8 col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                      <h2 style="text-align:center;">TRANG SỬA</h2>
                                                        <!--     enctype="multipart/form-data" dùng để gửi file từ form này sang form khác     -->
                                                        <form action="khach_hang_sua_thuc_hien.php" method="POST" enctype="multipart/form-data"> 
                                                            <p style="text-align:center;font-weight: bold;" >Ghi chú</p>
                                                            <p style="text-align:center;"><input type="text" name="txtGhiChu" value="<?php echo $row['kh_ghi_chu'];?>" placeholder="Ghi chú" style=" width: 80%;" ></p>                                                            
                                                            <p style="text-align: center;"><input type="hidden" name="txtID" value="<?php echo $row['kh_id'];?>"><button type="submit">Cập Nhật</button></p>
                                                        </form>
                                                </div>
                                                </div>
                                            </div>
