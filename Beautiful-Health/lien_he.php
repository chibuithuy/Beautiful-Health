      ...
      <div class="layout_padding2-top">
        <div class="row">
          ...
          <form method="post" action="thuc_hien_lien_he.php">
            ...
            <input name="kh_ho_ten" type="text" placeholder="Họ và tên">
            <br>
            <input name="kh_email" type="text" placeholder="Email">
            <br>
            <input name="kh_dien_thoai" type="text" placeholder="Số điện thoại">
            <br>
            <input name="kh_tin_nhan" lass="message_input" type="text" placeholder="Tin nhắn">
            <br>
        ...
        <div class="row">
          <div class="col-md-4">
            <a href="">
              ...
              <span>
                Ngõ 12 Chùa Bộc, Đống Đa, Hà Nội
              </span>
            </a>
          </div>
          <div class="col-md-4">
