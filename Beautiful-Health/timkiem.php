  ...
  //2, Lấy ra dữ liệu mong muốn ( TIN TỨC lưu trong csdl )
          ...
          if (isset($_POST["timkiem"]))
        {
          $tukhoa=$_POST['tukhoa'];
            ...
            $sql ="SELECT * FROM tbl_san_pham where sp_ten like '%".$tukhoa."%'";
...
<?php
       ...
       ?>
                <li>
                  <figure>
                    <a href="index.php?quanly=timkiem&id=<?php echo $row['sp_id']?>">
                    <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Thêm vào giỏ</a>
                    <figcaption>
                    <a class="aa-product-img" href="san_pham_chi_tiet.php?id=<?php echo $row["sp_id"];?>"><img src="<?= '../assets/img/product/'.$row["sp_anh"] ?>" alt="" width="175" height="200"></a>
                      <h4 class="aa-product-title"><a href="#"><?php echo $row["sp_ten"];?></a></h4>
                      <span class="aa-product-price" href="san_pham_chi_tiet.php?id=<?php echo $row["sp_id"];?>"><?php echo $row["sp_gia_tien"];?></span>
                      <p class="aa-product-descrip" href= "san_pham_chi_tiet.php?id=<?php echo $row["sp_id"];?>"><?php echo $row["sp_mo_ta"];?></p>
                    </figcaption>
                  </figure>                         
