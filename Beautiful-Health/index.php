      ...
      <div class="row">
        <div class="col-md-12">
          <div class="aa-latest-blog-area">
            <h2>CÙNG FIIN TRỞ NÊN XINH ĐẸP</h2>
            <div class="row">
                <?php 
                ...
                <div class="aa-latest-blog-single">
                  <figure class="aa-blog-img">                    
                    <a href="#"><img src="img/<?php echo $row['tt_anh']; ?></a>
  
                      <figcaption class="aa-blog-img-caption">
                      <span href="#"><i class="fa fa-eye"></i><?php echo $row["tt_so_luot_xem"];?></span>
                  
                      <span href="#"><i class="fa fa-clock-o"></i><?php echo date("d/M/Y", strtotime($row["tt_ngay_dang"]));?> </span>
                    </figcaption>                          
                  </figure>
                  <div class="aa-blog-info">
                    <h4><?php echo $row["tt_tieu_de"];?></h4>
                    <p><?php echo $row["tt_mo_ta"];?></p> 
                    <a href= "blog.php?id=<?php echo $row["tt_id"];?>" class="aa-read-mor-btn">Đọc thêm <span class="fa fa-long-arrow-right"></span></a>
                  </div>
                </div>
              </div>
