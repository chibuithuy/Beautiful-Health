        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
              ...
              <li><a href="index.php">Công cụ</a></li>
              <li><a href="san_pham.php">Sản phẩm<span class="caret"></span></a>
                <ul class="dropdown-menu">                
                  <li><a href="hat.php.php">Hạt</a></li>
                  <li><a href="tinh_bot.php.php">Tinh bột</a></li>
