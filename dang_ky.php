...
<head>
  ...
  <title>FinnSore | Đăng nhập</title>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="aa-myaccount-register">
                  <h4>Đăng ký</h4>
                  <form action="dang_ky_kiem_tra.php" method="POST" class="aa-login-form">
                    <label for="">Địa chỉ email<span>*</span></label>
                    <input type="text" placeholder="Địa chỉ email" name="txtEmail" required>
                    ...
                    <input type="password" placeholder="Mật khẩu" name="txtMatKhau" required>
